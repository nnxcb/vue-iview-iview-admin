    ...
    children: [
      {
        ...
        component: () => import('@/view/single-page/userinfo/index.vue')
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        component: () => import('@/view/user-manager/user-list/user-list.vue')
      },
      {
        path: '/user_add',
        name: 'user_add',
        ...
        component: () => import('@/view/user-manager/user-add/user-add.vue')
      }
    ]
  },
  {
